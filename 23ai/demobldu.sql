...
exec dbms_stats.gather_table_stats('','EMP')
exec dbms_stats.gather_table_stats('','DEPT')
exec dbms_stats.gather_table_stats('','SALGRADE')
exec dbms_stats.gather_table_stats('','BONUS')
