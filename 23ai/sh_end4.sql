...
col "Movie Title" format a40
col release_date format a16
...
pause
clear screen
pro SQL> select ai 'what is margot robbie highest grossing movie' showsql
exec chatdb('what is margot robbie highest grossing movie','showsql');
pro SQL> pause
pause
pro SQL> select ai 'what is margot robbie highest grossing movie' narrate
exec chatdb('what is margot robbie highest grossing movie','narrate');
pro SQL> pause
pause
clear screen
