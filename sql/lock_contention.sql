...
--
-------------------------------------------------------------------------------
create or replace view sys.misc_lock_contention as
SELECT  /*+ ORDERED */
...
grant select on sys.misc_lock_contention to public;

create or replace
public synonym misc_lock_contention for sys.misc_lock_contention;
