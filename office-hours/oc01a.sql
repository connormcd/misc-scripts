...
pause
clear screen
select num_rows, blocks*8192/1024/1024 megabyte
from user_tables
where table_name = 'TX';
pause
...
select 
  sum(s.high_optimal_size * (  s.optimal_executions - b.optimal_executions )) MEMORY_USED, 
  sum(s.high_optimal_size * (s.onepass_executions - b.onepass_executions)) DISK_USED 
